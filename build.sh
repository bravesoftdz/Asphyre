...
function ultibo-bash-quotation {
    ...
    then
        ...
        local DOCKER_IMAGE=markfirmware/ultibo-1.3.271-serial-notifier-x64-1.0.0
...
function build-ultibo-asphyre-basic {
    local src=Samples/FreePascal/Ultibo/Basic
